...
dataset_path = '/global/homes/y/yoki/roman/desi_like_samples/diffsky/data/sim_data/lrg_1000deg2/lrg_sim_cat_halo_mass.hdf5'
...
def save_mock_lrg_cat(dataset_path=dataset_path):
    ...
    mask_mass = sim_cat['log_halo_mass'] > threshold_all
    
    # drop duplicate columns
    cols_to_drop = ['logsm_obs', 'logmp_obs']
    sim_cat.drop(cols_to_drop, axis=1, inplace=True)
    ...
    rand_output_file_name = f'rand_lrg_cat_halo_mass.parquet'
    ...
    output_file_name = f'mock_lrg_cat_halo_mass.parquet'
