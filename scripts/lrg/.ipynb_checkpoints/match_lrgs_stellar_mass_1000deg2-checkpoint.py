...
path_mass_thres = f'/pscratch/sd/y/yoki/desi_like_data_diffsky/data/selection_thresholds/lrg/stellar_mass_thres_1000deg2.npy'
dataset_path = f'/global/homes/y/yoki/roman/desi_like_samples/diffsky/data/sim_data/lrg_1000deg2/lrg_sim_cat_1000deg2.hdf5'
...
def save_mock_lrg_cat(dataset_path=dataset_path):
    ...
    patches = np.array([0, 5, 10, 15, 20, 25, 30, 35])
    list_array_ra = []
    list_array_dec = []
    ...
    rand_output_file_name = f'rand_lrg_cat_1000deg2.parquet'
    ...
    output_file_name = f'mock_lrg_cat_1000deg2.parquet'
